...
public interface EnderecoRepository extends JpaRepository<Endereco, Long> {
    @Query("SELECT new com.spring.ApiSystem.dto.endereco.response.ResEnderecoDTO(e.id, e.numero, e.complemento, e.unidade, e.tipo, e.cep) FROM endereco e WHERE e.usuario.id = :usuarioId")
