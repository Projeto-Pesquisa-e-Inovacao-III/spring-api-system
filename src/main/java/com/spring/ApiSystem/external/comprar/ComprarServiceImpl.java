...
import static com.spring.ApiSystem.shared.utils.MoneyUtil.toCents;

@Service
@ConditionalOnProperty(name = "app.mock.payment.enabled", havingValue = "false", matchIfMissing = true)
public class ComprarServiceImpl implements ComprarService{

    private static final Logger log = LoggerFactory.getLogger(ComprarServiceImpl.class);
    ...
    public ComprarServiceImpl(JpaUserDetailsService userDetailsService, RestTemplate restTemplate, ProdutoExibicaoService produtoExibicaoService, ProdutoContratadoService produtoContratadoService) {
        ...
        ReqCheckoutDto requestBody = new ReqCheckoutDto(
                new ReqCheckoutDto.CustomerDto(
                        ...
                        new ReqCheckoutDto.PhoneDto(
                                formatCountryToGateway(telefone),
